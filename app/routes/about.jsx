...
export const meta = () => {
  return [
    {title: "About Enhance Printing - Colorado's One-Stop-Shop"} ,
    {name: "copyright", content: "Copyright &amp;copy; 2023 Enhance Printing, All rights reserved."},
    {name: "description", content: "For over 40 years we have provided professional, cost-effective printing and graphic design to Fort Collins and the Front Range. Offering a wide array of graphic design, printing, and branding services, we strive to be Northern Colorado’s One-Stop-Shop to support your brand and vision."},    
   {name: "og:title", content: "About Enhance Printing"},
   {name: "og:description", content: "For over 40 years we have provided professional, cost-effective printing and graphic design to Fort Collins and the Front Range. Offering a wide array of graphic design, printing, and branding services, we strive to be Northern Colorado’s One-Stop-Shop to support your brand and vision."},
